 ...
 */
public class DialogLauncher extends Dialog implements WindowListener {
     ...
     */
    public DialogLauncher(Frame parent, String title, Thinlet content, int xpos, int ypos, int width, int height){
        this(parent, title, content, xpos, ypos, width, height, false);
    }
